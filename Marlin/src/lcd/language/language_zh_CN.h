...
namespace Language_zh_CN {
  ...
  LSTR MSG_MANUAL_MESH                    = _UxGT("手动创建网格");
  LSTR MSG_AUTO_MESH                      = _UxGT("自动创建网格");
  ...
  LSTR MSG_UBL_EDIT_CUSTOM_MESH           = _UxGT("编辑自定义网格");     // "Edit Custom Mesh"
  LSTR MSG_UBL_FINE_TUNE_MESH             = _UxGT("微调网格");     // "Fine Tuning Mesh"
  LSTR MSG_UBL_DONE_EDITING_MESH          = _UxGT("完成编辑网格");     // "Done Editing Mesh"
  LSTR MSG_UBL_BUILD_CUSTOM_MESH          = _UxGT("创建自定义网格");     // "Build Custom Mesh"
  LSTR MSG_UBL_BUILD_MESH_MENU            = _UxGT("创建网格");     // "Build Mesh"
  #if HAS_PREHEAT
  ...
  LSTR MSG_UBL_FINE_TUNE_ALL              = _UxGT("微调所有的");     // "Fine Tune All"
  LSTR MSG_UBL_FINE_TUNE_CLOSEST          = _UxGT("微调附近的");     // "Fine Tune Closest"
  ...
  LSTR MSG_UBL_STEP_BY_STEP_MENU          = _UxGT("逐步UBL");     // "Step-By-Step UBL"
  LSTR MSG_UBL_1_BUILD_COLD_MESH          = _UxGT("1. 创设冷网格");
  LSTR MSG_UBL_2_SMART_FILLIN             = _UxGT("2. 自动填充");
  LSTR MSG_UBL_3_VALIDATE_MESH_MENU       = _UxGT("3. 批准网格");
  LSTR MSG_UBL_4_FINE_TUNE_ALL            = _UxGT("4. 微调全部");
  LSTR MSG_UBL_5_VALIDATE_MESH_MENU       = _UxGT("5. 批准网格");
  LSTR MSG_UBL_6_FINE_TUNE_ALL            = _UxGT("6. 微调全部");
  ...
  LSTR MSG_INTENSITY_R                    = _UxGT("红");     // "Red Intensity"
  LSTR MSG_INTENSITY_G                    = _UxGT("绿");     // "Green Intensity"
  LSTR MSG_INTENSITY_B                    = _UxGT("蓝");     // "Blue Intensity"
  LSTR MSG_INTENSITY_W                    = _UxGT("白");     // "White Intensity"
  ...
  LSTR MSG_HOTEND_TOO_COLD                = _UxGT("热端未加热!");
  ...
  LSTR MSG_MESH_Z_OFFSET                  = _UxGT("网格Z偏移");     // "Bed Z"
  ...
  LSTR MSG_PID_BAD_HEATER_ID              = _UxGT("自动调整失败! 坏的挤出机");
  LSTR MSG_PID_TEMP_TOO_HIGH              = _UxGT("自动调整失败! 温度太高");
  LSTR MSG_PID_TIMEOUT                    = _UxGT("自动调整失败! 超时");
  LSTR MSG_SELECT_E                       = _UxGT("选择 *");
  LSTR MSG_ACC                            = _UxGT("加速度");     // "Accel" acceleration
  LSTR MSG_JERK                           = _UxGT("抖动速率");     // "Jerk"
  LSTR MSG_VA_JERK                        = _UxGT("A轴抖动") STR_A;     // "Va-jerk"
  LSTR MSG_VB_JERK                        = _UxGT("B轴抖动") STR_B;     // "Vb-jerk"
  LSTR MSG_VC_JERK                        = _UxGT("C轴抖动") STR_C;     // "Vc-jerk"
  LSTR MSG_VN_JERK                        = _UxGT("@轴抖动");          // "V@-jerk"
  LSTR MSG_VE_JERK                        = _UxGT("挤出机抖动");     // "Ve-jerk"
  LSTR MSG_JUNCTION_DEVIATION             = _UxGT("接角偏差");
  LSTR MSG_MAX_SPEED                      = _UxGT("速度");     // "Velocity"
  LSTR MSG_VMAX_A                         = _UxGT("A最大进给") STR_A;     // "Vmax " max_feedrate_mm_s
  LSTR MSG_VMAX_B                         = _UxGT("B最大进给") STR_B;
  LSTR MSG_VMAX_C                         = _UxGT("C最大进给") STR_C;
  LSTR MSG_VMAX_N                         = _UxGT("@最大进给");
  LSTR MSG_VMAX_E                         = _UxGT("E最大进给");
  LSTR MSG_VMAX_EN                        = _UxGT("*最大进给");
  LSTR MSG_VMIN                           = _UxGT("最小进给");     // "Vmin"  min_feedrate_mm_s
  LSTR MSG_VTRAV_MIN                      = _UxGT("最小移动进给");     // "VTrav min" min_travel_feedrate_mm_s, (target) speed of the move
  ...
  LSTR MSG_AMAX_E                         = _UxGT("E最大打印加速度");
  LSTR MSG_AMAX_EN                        = _UxGT("*最大打印加速度");
  LSTR MSG_A_RETRACT                      = _UxGT("回抽加速度");     // "A-retract" retract_acceleration, E acceleration in mm/s^2 for retracts
  LSTR MSG_A_TRAVEL                       = _UxGT("非打印移动加速度");     // "A-travel" travel_acceleration, X, Y, Z acceleration in mm/s^2 for travel (non printing) moves
  LSTR MSG_INPUT_SHAPING                  = _UxGT("共振补偿");
  LSTR MSG_SHAPING_ENABLE                 = _UxGT("启用 @ 补偿");
  LSTR MSG_SHAPING_DISABLE                = _UxGT("关闭 @ 补偿");
  LSTR MSG_SHAPING_FREQ                   = _UxGT("@ 频率");
  LSTR MSG_SHAPING_ZETA                   = _UxGT("@ 减振");
  ...
  LSTR MSG_ADVANCE_K_E                    = _UxGT("压力提前 K *");
  ...
  LSTR MSG_INFO_MACHINENAME               = _UxGT("Prodmach 666");
  ...
  LSTR MSG_CONTROL_RETRACT_SWAP           = _UxGT("换线回抽长度mm");     // "Swap Re.mm" swap_retract_length, swap retract length (positive mm), for extruder change
  LSTR MSG_CONTROL_RETRACTF               = _UxGT("回抽速率mm/s");     // "Retract V" retract_feedrate_mm_s, feedrate for retracting (mm/s)
  LSTR MSG_CONTROL_RETRACT_ZHOP           = _UxGT("Z举升 mm");     // "Hop mm" retract_zraise, retract Z-lift
  ...
  LSTR MSG_CONTROL_RETRACT_RECOVER_SWAP   = _UxGT("换线回抽恢复长度mm");     // "S UnRet+mm" swap_retract_recover_extra, additional swap recover length (mm, added to retract length when recovering from extruder change)
  ...
  LSTR MSG_AUTORETRACT                    = _UxGT("自动回抽");     // "Auto-Retract" autoretract_enabled,
  ...
  LSTR MSG_HOTEND_IDLE_TIMEOUT            = _UxGT("热端闲置超时");
  ...
  LSTR MSG_FILAMENT_CHANGE_HEADER         = _UxGT("换料");
