...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 5*60, 25*60, 15*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, I, E from panel
...
#define ADVANCED_PAUSE_FEATURE // 换料程序
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH     1108  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH  1108  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define I_STALL_SENSITIVITY  65 // TMC 无传感器回原点灵敏度
